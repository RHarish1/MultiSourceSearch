...
app.get("/index", preventAuthForLoggedIn, (_req, res) => res.sendFile(path.join(__dirname, "public", "index.html")));
app.get("/register", preventAuthForLoggedIn, (_req, res) => res.sendFile(path.join(__dirname, "public", "register.html")));
