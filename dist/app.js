...
app.get("/index", preventAuthForLoggedIn, (req, res) => res.sendFile(path.join(__dirname, "public", "index.html")));
app.get("/register", preventAuthForLoggedIn, (req, res) => res.sendFile(path.join(__dirname, "public", "register.html")));
